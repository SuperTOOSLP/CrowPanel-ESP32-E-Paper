...
const char* ssid = "Tu clave wifi";
const char* password = "tu contraseña wifi";

// OpenWeatherMap API key
String openWeatherMapApiKey = "tu clave api";

// City and country code to query
String city = "tu ciudad";
String countryCode = "codigo de tu ciudad";  /// este código lo obtienes con el programa de python que está en el repositorio
